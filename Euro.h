...
namespace vklad {
	...
	/// Сводка для Euro
	/// </summary>
	public ref class Euro : public System::Windows::Forms::Form
	{
	public:
		Euro(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Euro::typeid));
			...
			this->оПрограммеToolStripMenuItem->Click += gcnew System::EventHandler(this, &Euro::оПрограммеToolStripMenuItem_Click);
			// 
			...
			this->помощьToolStripMenuItem->Click += gcnew System::EventHandler(this, &Euro::помощьToolStripMenuItem_Click);
			// 
			// contextMenuStrip1
			// 
			...
			this->checkBox4->CheckedChanged += gcnew System::EventHandler(this, &Euro::checkBox4_CheckedChanged);
			// 
			// panel3
			// 
			...
			this->textBox5->Size = System::Drawing::Size(164, 55);
			...
			this->textBox4->Size = System::Drawing::Size(164, 55);
			...
			this->textBox1->Size = System::Drawing::Size(154, 37);
			...
			this->checkBox2->CheckedChanged += gcnew System::EventHandler(this, &Euro::checkBox2_CheckedChanged);
			// 
			// checkBox1
			// 
			...
			this->checkBox1->CheckedChanged += gcnew System::EventHandler(this, &Euro::checkBox1_CheckedChanged);
			// 
			// trackBar3
			// 
			this->trackBar3->BackColor = System::Drawing::SystemColors::Control;
			this->trackBar3->LargeChange = 490;
			this->trackBar3->Location = System::Drawing::Point(6, 140);
			this->trackBar3->Maximum = 5000;
			this->trackBar3->Minimum = 100;
			this->trackBar3->Name = L"trackBar3";
			this->trackBar3->Size = System::Drawing::Size(470, 45);
			this->trackBar3->TabIndex = 22;
			this->trackBar3->TickFrequency = 490;
			this->trackBar3->Value = 100;
			this->trackBar3->Scroll += gcnew System::EventHandler(this, &Euro::trackBar2_Scroll);
			// 
			// label5
			// 
			...
			this->textBox2->Text = L"1 год";
			// 
			// label12
			// 
			this->label12->AutoSize = true;
			this->label12->Font = (gcnew System::Drawing::Font(L"Bahnschrift Light", 8));
			this->label12->Location = System::Drawing::Point(439, 115);
			...
			this->label13->Location = System::Drawing::Point(3, 114);
			...
			this->trackBar1->Scroll += gcnew System::EventHandler(this, &Euro::trackBar1_Scroll);
			// 
			// Euro
			// 
...
#pragma endregion
    ...
    private: System::Void vklad::Euro::efrash();
